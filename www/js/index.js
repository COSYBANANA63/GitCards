    ...
    card.innerHTML = `
        <div class="card-menu">
            ...
            <div class="card-menu-dropdown hidden">
                <button onclick="event.stopPropagation(); shareGitHubProfile('${profile.username}')">
                ...
                <button onclick="event.stopPropagation(); showMessageDialog(${profile.id}, '${profile.name}')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="action-icon">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                    </svg>
                    Messages
                </button>
                <button onclick="event.stopPropagation(); window.open('https://github.com/${profile.username}', '_blank')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="action-icon">
